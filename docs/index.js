...
var _ToggleTodo = __webpack_require__(72);

var _ToggleTodo2 = _interopRequireDefault(_ToggleTodo);

var _DestroyTodo = __webpack_require__(73);

var _DestroyTodo2 = _interopRequireDefault(_DestroyTodo);

var _ManageTodos = __webpack_require__(74);

var _ManageTodos2 = _interopRequireDefault(_ManageTodos);

var _StorageWrapper = __webpack_require__(77);
 ...
 * @param {Object}  item.id  Identificador da tarefa
 */
var DestroyTodo = function DestroyTodo() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  var item = arguments[1];
...
var _FilterTodos = __webpack_require__(75);

var _FilterTodos2 = _interopRequireDefault(_FilterTodos);

var _OrderTodos = __webpack_require__(76);
...
var ManageTodos = function ManageTodos() {
  ...
  newList = (0, _OrderTodos2.default)(newList, order);
  newList = (0, _FilterTodos2.default)(newList, filter);

  return newList;
};

exports.default = ManageTodos;
 ...
 * @param {String}  order  Direção da ordenação
 */
var OrderTodos = function OrderTodos() {
  var list = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  var order = arguments[1];
...
var sort = {
  ...
  DESC: function DESC(list) {
    return list.reverse();
  }
};

exports.default = OrderTodos;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.props.filtered.map(function (item) {
            return _react2.default.createElement(_Todo2.default, { item: item, key: 'todo-' + item.id });
          })
        )
      );
    }
  ...
  _createClass(Todo, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { className: 'todos-todo__destroy', onClick: function onClick() {
...
var DeleteIcon = function (_Component) {
  _inherits(DeleteIcon, _Component);
...
var OrderTodos = function (_Component) {
  _inherits(OrderTodos, _Component);

  function OrderTodos() {
    _classCallCheck(this, OrderTodos);

    return _possibleConstructorReturn(this, (OrderTodos.__proto__ || Object.getPrototypeOf(OrderTodos)).apply(this, arguments));
  }

  _createClass(OrderTodos, [{
    key: 'orderBy',
...
var FilterTodos = function (_Component) {
  _inherits(FilterTodos, _Component);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { onClick: function onClick() {
              return _this2.filterBy('completed');
            },
        ...
        _react2.default.createElement(
          'button',
          { onClick: function onClick() {
              return _this2.filterBy('incomplete');
            },
