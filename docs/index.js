...
var _Todos = __webpack_require__(27);
 ...
 * Import React.js
 */
_reactDom2.default.render(_react2.default.createElement(_Todos2.default, null), document.getElementById('app'));
...
var _StorageWrapper = __webpack_require__(28);
...
var Todos = function (_Component) {
  ...
  function Todos(props) {
    ...
    _this.storage = new _StorageWrapper2.default('todos');
    _this.orderByStorage = new _StorageWrapper2.default('orderBy');
  ...
  _createClass(Todos, [{
    ...
    key: 'destroyItem',
    value: function destroyItem(destroidItem) {
      var list = this.state.list.filter(function (item) {
        return item !== destroidItem;
      });
    ...
    value: function filter(list) {
      ...
      return list.filter(function (item) {
        ...
        if (_this2.state.filter === 'all') {
          return true;
        }

        /** Retorna as tarefas completadas */
        if (_this2.state.filter === 'completed') {
          return item.isComplete;
        }

        /** Retorna as tarefas não completadas */
        if (_this2.state.filter === 'incomplete') {
          return !item.isComplete;
        }
      });
    }
        ...
        _react2.default.createElement(
          ...
          this.list().map(function (item, key) {
            return _react2.default.createElement(_Todo2.default, {
              item: item,
              key: 'todo-' + key,
              destroy: _this3.destroyItem,
              complete: _this3.completeItem
            });
          })
        )
      );
...
var _DeleteIcon = __webpack_require__(30);
...
var TodoForm = function (_Component) {
  ...
  _createClass(TodoForm, [{
    ...
    value: function submit() {
      ...
      this.props.onSubmit(this.todo(this.state.input));
